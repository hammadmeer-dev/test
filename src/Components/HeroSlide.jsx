...
function HeroSlide({setIsOpen,IsOpen}) {
  return (
    <div><div className="flex flex-wrap justify-between md:p-2 text-white ">
            ...
            <div className="order-1 w-full md:order-2 md:w-1/2 flex justify-center items-center md:pt-[60px] md:pl-[150px]">
              <img
                ...
                alt="hero"
                className="md:h-[370] transform object-cover object-center"
              />
              <div className='absolute flex justify-center items-center transform translate-y-2 translate-x-2'> 
                    <button className='w-[85px] h-[85px] bg-black text-white rounded-full shadow-lg justify-center text-center flex ' onClick={() => setIsOpen(true)}><img src='/play-icon.png' className='h-8 w-8 mx-auto my-auto'/></button>
              </div>
            </div>
